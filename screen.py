...
def main():
	...
	while True:
		 ...
		 lcd_text("I love my pi",LCD_LINE_1)
		 lcd_text("16x9",LCD_LINE_2)

		 time.sleep(3) # 3 second delay

		 lcd_text("ABDEF",LCD_LINE_1)
		 lcd_text("123123456",LCD_LINE_2)

		 time.sleep(3) # 3 second delay

		 lcd_text("I even like chocolate pi",LCD_LINE_1)
		 lcd_text("and apple pi!",LCD_LINE_2)

		 time.sleep(3)

		 lcd_text("Happy Pi!!!!",LCD_LINE_1)
		 lcd_text("Pi! Pi! Pi!",LCD_LINE_2)
